import { Lightbulb, Rocket, Target, Linkedin, Twitter, Github, Star, CheckCircle, ArrowRight, Sparkles, Heart, Zap } from "lucide-react";
...
const AboutPage = () => {
  ...
  return (
    <div className="pt-20">
      ...
      <section className="py-24 relative bg-gradient-to-br from-gray-50 via-blue-50/30 to-indigo-50/20 overflow-hidden">
        {/* Background Elements */}
        <div className="absolute inset-0">
          <div className="absolute top-1/4 left-0 w-96 h-96 bg-blue-100/20 rounded-full blur-3xl"></div>
          <div className="absolute bottom-1/4 right-0 w-80 h-80 bg-purple-100/15 rounded-full blur-3xl"></div>
        </div>
          ...
          {/* Section Header */}
            <div className="text-center mb-20">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto font-light leading-relaxed">
                The passionate individuals behind Craft's success, bringing together diverse expertise and shared vision for digital excellence.
            </p>
          </div>
            ...
            {teamMembers.map((member, index) => (
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                  <h3 className="text-lg font-bold mb-1 group-hover:text-blue-300 transition-colors duration-300">
                    {member.name}
                  </h3>
                ...
                {/* Hover Overlay */}
                <div className="absolute inset-0 bg-black/70 opacity-0 group-hover:opacity-100 transition-all duration-500 flex flex-col items-center justify-center text-white p-6">
                  {/* Bio */}
                  <p className="text-sm text-center leading-relaxed mb-6 text-gray-200">
                    {member.bio}
                  </p>
                  ...
                  <div className="flex gap-4">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-12 h-12 bg-gray-800 hover:bg-gray-900 text-white rounded-xl flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg"
